...
<body style="background-color: #E7E7E7">
	...
	<div class="container mt-5 p-4" style="width: 30%; background-color: #F2F2F2; box-shadow: 1px 4px 81px -4px rgba(0, 0, 0, 0.63); border-radius: 5px;">
		<h1 class="text-center font-weight-light mb-4">
			<s:message code='user.profile.title.edit' />
		</h1>
		
		<sf:form id="usersForm" action="/user/update" modelAttribute="user" enctype="multipart/form-data" method="POST">
			<sf:hidden path="id"/>
			...
			<input type="button" value="<s:message code="button.cancel"/>" class="btn btn-secondary" onclick="window.location.href='${pageContext.request.contextPath}/profile'" />
